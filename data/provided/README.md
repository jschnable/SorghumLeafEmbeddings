...
- LysM mass phenotypes are beside their figure in `figures/supplemental/FigS14_lysm_yield/`. Its renderer reads six saved tests generated by `scripts/prepare_lysm_yield_tests.py`.
