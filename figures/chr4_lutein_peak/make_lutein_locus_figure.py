#!/usr/bin/env python3
"""chr4:4.7 locus panel. Manhattan of the 14 peak embeddings + LD-to-lead + gene models.Tight LD block (r2>0.5, ~10 kb) around lead 4,724,594. Highlighted: VQ defense gene
Sobic.004G058000 (top cis-eQTL), CYP97B lutein Sobic.004G057900 (a-priori candidate),
and Sobic.004G058050 (only gene under the LD block; Met290Ile r2=0.47).
Regenerate: python figures/chr4_lutein_peak/make_lutein_locus_figure.py"""
...
D = Path("figures/chr4_lutein_peak")
FS = 9
...
C_VQ = "#2c7fb8"; C_LUT = "#d19a1e"; C_BLK = "#7a4fa3"
MISS = 4_731_911   # Sobic.004G058050 Met290Ile, best coding tag (r2=0.47)
CAND = {"Sobic.004G058000": ("Sobic.004G058000\nVQ defense (top eQTL)", 4.700, C_VQ),
        "Sobic.004G057900": ("Sobic.004G057900\nCYP97B lutein", 4.678, C_LUT),
        "Sobic.004G058050": ("Sobic.004G058050\nuncharacterized", 4.756, C_BLK)}
...
ax_gene.annotate("Met290Ile\n(r²=0.47)", xy=(MISS / 1e6, FWD[1]), xytext=(MISS / 1e6, 1.02), ha="center", va="bottom",
...
fig.savefig(D / "lutein_locus.png", dpi=300, bbox_inches="tight")
print("wrote", D / "lutein_locus.png")
print(f"dims shown: {len(keep)} | lead {PEAK} (-log10 p={ymax:.2f}) | genes in window: {len(genes)}")
