...
After rendering the Figure 2 statistical panels, run `python figures/main/Fig2_embeddings/assemble_current_figure2.py` to update its retained workflow assembly. The Figure 3 renderer writes `figure3_from_code.png`. FigS5, FigS8 and FigS16 component plots use `_from_code.png` filenames to preserve the edited final figures.
