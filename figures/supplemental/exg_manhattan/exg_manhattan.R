...
p <- plotManhattan(pmap, p_value, resampling = FALSE, threshold = thresh, main = 'Percent Unhealthy Leaf Tissue', colors = rep(colors, 5), theme = theme_use, species = 'sorghum')
ggsave('exg_manhattan.png', plot = p, width = 6.5, height = 4)
