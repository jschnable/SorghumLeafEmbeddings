#!/usr/bin/env python3
"""Test whether the chr9 JA-hotspot candidate's leaf expression (log2 TPM,
Sobic.009G249900 / JAR1-like jasmonate-Ile ligase) is associated with
...
VanRaden kinship with the gene's own chromosome (Chr09) left out (LOCO), Wald
...
(fit_markers_lrt_batch_prebuilt) used internally, against the Chr09 LOCO
kinship eigendecomposition. This mirrors
figures/supplemental/lysm_hotspot/compute_g019100_tpm_human_score_test.py.
...
Writes chr9_candidate_tpm_human_score_significance.csv + .metadata.json next
to this script.
"""
...
EXPRESSION_CSV = OUT / "chr9_candidate_expression.csv"
DISEASE_CSV = OUT / "human_disease_scores.csv"

CANDIDATE_GENE = "Sobic.009G249900"  # JAR1-like jasmonate-Ile ligase
PREDICTOR_COL = "chr9_candidate_log2_tpm"
...
def main() -> None:
    ...
    out_csv = OUT / "chr9_candidate_tpm_human_score_significance.csv"
