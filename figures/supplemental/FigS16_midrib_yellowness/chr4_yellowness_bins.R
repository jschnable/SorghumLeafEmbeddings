...
# human disease score column chart (see figures/supplemental/FigS11_gdsl_hotspots/gdsl_hotspots.R) to
...
p_yellow <- plot_yellowness_bins('bin_pergeno.csv.gz', chr4_marker_col, lead_marker_genotypes, chr4_colors,
                                 marker_name = '4:65447981')
ggsave('chr4_yellowness_bins_from_code.png', plot = p_yellow, dpi = 300, bg = 'white', width = 3, height = 3)
