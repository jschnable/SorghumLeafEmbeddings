...
LEAD = 60_857_595
PEAK_DIMS = ["embedding_mean_711", "embedding_std_521", "embedding_std_710"]  # 3 lowest-p peak dims at chr9:60.8
...
gt = subprocess.run(["bcftools", "query", "-r", f"9:{LEAD}-{LEAD}", "-f", "[%GT\t]\n", VCF], capture_output=True, text=True).stdout.strip().split("\t")
