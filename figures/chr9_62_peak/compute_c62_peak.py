#!/usr/bin/env python3
"""Region GWAS + LD + gene models for the chr9:62.2 disease-embedding peak (panel A inputs).
Broad ~500 kb region with two LD blocks (~60 genes). Lead marker = 62,301,540."""
...
CHROM, LO, HI = "9", 62_120_000, 62_480_000
PEAK_MARKER = 62_301_540
