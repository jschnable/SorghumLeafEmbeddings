#!/usr/bin/env python3
"""Region GWAS + LD + gene models for the chr4:60.5 peak (panel A inputs).
Two sub-loci: A ~60.556-60.559 Mb (UGT Sobic.004G230800), B ~60.581 Mb (markers inside
pectin methyltransferase Sobic.004G231300). Lead marker = strongest SAM3 hit 60,556,616."""
...
CHROM, LO, HI = "4", 60_480_000, 60_660_000
PEAK_MARKER = 60_556_616
