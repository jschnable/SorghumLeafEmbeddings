#!/usr/bin/env python3
"""Region GWAS + LD + gene models for the chr6:58.5 (P pigment) peak (panel A inputs).
Lead marker = strongest SAM3 hit 58,476,610 (6:58476610:G:A)."""
...
CHROM, LO, HI = "6", 58_330_000, 58_620_000
PEAK_MARKER = 58_476_610
