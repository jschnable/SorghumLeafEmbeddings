#!/usr/bin/env python3
"""Region GWAS + LD + gene models for the chr2:52.5 gloss/cuticle peak (panel A inputs)."""
...
CHROM, LO, HI = "2", 52_300_000, 52_650_000
PEAK_MARKER = 52_490_664
SCR = "/tmp/claude-1000/-home-james-leaf-imaging-SorghumLeafEmbeddings/3fda1355-5801-496a-b3ac-1df149c82fb7/scratchpad"
PEAK_DIMS = json.load(open(f"{SCR}/appearance_peak_dims.json"))["chr2_52.5"]
