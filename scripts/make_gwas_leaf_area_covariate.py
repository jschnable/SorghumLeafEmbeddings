...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--out", type=Path,
                   default=REPO_ROOT / "data" / "generatable" / "covariates"
                   / "gwas_covariates_leaf_area_flowering_time.csv",
                   help="Generated covariate CSV. The frozen provided covariate is not overwritten by default.")
...
def main() -> None:
    ...
    args = argparse.Namespace(
        ...
        vc_cpu=a.vc_cpu, progress_every=0, no_plot_averaging=False,
    )
