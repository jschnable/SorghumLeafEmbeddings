...
The transverse coordinate runs from one leaf margin through the midrib to the
opposite margin. Bin 0 and bin 99 denote margins, not anatomical left/right sides.
"""
